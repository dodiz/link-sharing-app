...
export default function Page() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between gap-6 mt-10 p-5 rounded-md bg-secondary-200">
        <Typography variant="body-m" className="text-secondary-400">
          Profile Picture
        </Typography>
        <div className="flex flex-col justify-center gap-2 items-center bg-primary-100 h-full px-9 py-15 rounded-md">
          <svg
